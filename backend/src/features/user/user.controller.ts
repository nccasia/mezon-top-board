...
export class UserController {
  ...
  @Get("public")
  @ApiBearerAuth()
  @ApiResponse({ type: GetUserPublicInfoResponse })
  async getUserPublicDetails(@Query() query: GetUserPublicInfoRequest) {
    return this.userService.getUserPublicInfo(query.userId);
  }
