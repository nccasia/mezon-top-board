...
export class MezonAppService {
  ...
  async updateMezonApp(userUpdating: User, req: UpdateMezonAppRequest) {
    ...
    const cleanedDescription = sanitizeHtml(description, {
      ...
      allowedClasses: {
        span: ['ql-size-small', 'ql-size-large', 'ql-size-huge', 'ql-align-center', 'ql-align-right', 'ql-align-justify'],
        p: ['ql-size-small', 'ql-size-large', 'ql-size-huge', 'ql-align-center', 'ql-align-right', 'ql-align-justify'],
      },
      allowedStyles: {
        '*': {
          'color': [/^.*$/],
